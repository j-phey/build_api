# Stores all our cli commands. We usually use @app.cli.command() but since it is bad practice to pass around the app variable we will instead use a blueprint
